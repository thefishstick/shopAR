...
Pod::Spec.new do |spec|
  ...
  spec.name         = "shopAR"
  spec.version      = "1.2"
  spec.summary      = "shopAR enables iOS apps to easily embed AR content"
...
shopAR is a tool used to help people embed AR content in their apps. It makes it very easy to add AR files and content in any recent swift app.
                   DESC
  ...
  #spec.author             = { "" => "" }
  spec.author    = "Johan Todi and Max Model"
  # spec.authors            = { "" => "" }
